...
//                _titleIconView.layer.masksToBounds = YES;
//                _titleIconView.layer.cornerRadius = self.frame.size.width/2;
//                _titleIconView.layer.borderWidth = 0.5;
//                _titleIconView.layer.borderColor = [UIColor colorWithHexString:@"0xdddddd"].CGColor;
//                if (title) {
...
//                break;
            case XTSegmentControlItemTypeTitleAndIcon:
            {
                _titleLabel = ({
                    ...
                    label.text = title;
                    label.textColor = [UIColor colorWithHexString:@"0xD8D8D8"];
...
- (void)setSelected:(BOOL)selected
{
    switch (_type) {
        ...
        {
            if (_titleLabel) {
                [_titleLabel setTextColor:(selected ? [UIColor colorWithHexString:@"0x00AAEC"]:[UIColor colorWithHexString:@"0xD8D8D8"])];
            }
            if (_titleIconView) {
...
- (void)addRedLine
{
    if (!_lineView) {
        ...
        _lineView.backgroundColor = [UIColor colorWithHexString:@"0x00AAEC"];
