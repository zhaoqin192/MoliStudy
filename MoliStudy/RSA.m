...
- (NSString *) encryptWithString:(NSString *)content {
    ...
    data = [self encryptWithData:[content dataUsingEncoding:NSUTF8StringEncoding]];
    
    NSData *encodedata = [GTMBase64 encodeData:data];
    
    NSString *encoderresult = [[NSString alloc] initWithData:encodedata encoding:NSUTF8StringEncoding];
  
    
    self.str1 = encoderresult;
